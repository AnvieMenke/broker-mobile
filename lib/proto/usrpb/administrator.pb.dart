...
class Access extends $pb.GeneratedMessage {
  ...
  factory Access.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Access.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Access', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
...
class AcceptClientNoticeRequest extends $pb.GeneratedMessage {
  factory AcceptClientNoticeRequest({
    $core.int? usrId,
  }) {
    final result = create();
    if (usrId != null) result.usrId = usrId;
  ...
  AcceptClientNoticeRequest._();

  factory AcceptClientNoticeRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AcceptClientNoticeRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AcceptClientNoticeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'usrId', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AcceptClientNoticeRequest clone() => AcceptClientNoticeRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AcceptClientNoticeRequest copyWith(void Function(AcceptClientNoticeRequest) updates) => super.copyWith((message) => updates(message as AcceptClientNoticeRequest)) as AcceptClientNoticeRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AcceptClientNoticeRequest create() => AcceptClientNoticeRequest._();
  @$core.override
  AcceptClientNoticeRequest createEmptyInstance() => create();
  static $pb.PbList<AcceptClientNoticeRequest> createRepeated() => $pb.PbList<AcceptClientNoticeRequest>();
  @$core.pragma('dart2js:noInline')
  static AcceptClientNoticeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AcceptClientNoticeRequest>(create);
  static AcceptClientNoticeRequest? _defaultInstance;
...
class CreateAccessResponse extends $pb.GeneratedMessage {
  ...
  factory CreateAccessResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory CreateAccessResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateAccessResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
    ..aOM<Access>(1, _omitFieldNames ? '' : 'access', subBuilder: Access.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  Access get access => $_getN(0);
  @$pb.TagNumber(1)
  set access(Access value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasAccess() => $_has(0);
  @$pb.TagNumber(1)
  void clearAccess() => $_clearField(1);
  @$pb.TagNumber(1)
  Access ensureAccess() => $_ensure(0);
}

class DeleteAccessRequest extends $pb.GeneratedMessage {
  factory DeleteAccessRequest({
    $core.int? accessId,
  }) {
    final result = create();
    if (accessId != null) result.accessId = accessId;
  ...
  DeleteAccessRequest._();

  factory DeleteAccessRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DeleteAccessRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteAccessRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'accessId', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteAccessRequest clone() => DeleteAccessRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteAccessRequest copyWith(void Function(DeleteAccessRequest) updates) => super.copyWith((message) => updates(message as DeleteAccessRequest)) as DeleteAccessRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DeleteAccessRequest create() => DeleteAccessRequest._();
  @$core.override
  DeleteAccessRequest createEmptyInstance() => create();
  static $pb.PbList<DeleteAccessRequest> createRepeated() => $pb.PbList<DeleteAccessRequest>();
  @$core.pragma('dart2js:noInline')
  static DeleteAccessRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteAccessRequest>(create);
  static DeleteAccessRequest? _defaultInstance;
...
class AccountAccess extends $pb.GeneratedMessage {
  factory AccountAccess({
    $core.int? accountAccessId,
    $core.int? usrId,
    $core.String? correspondent,
    $core.String? rep,
    $core.String? branch,
    ...
    final result = create();
    if (accountAccessId != null) result.accountAccessId = accountAccessId;
    if (usrId != null) result.usrId = usrId;
    if (correspondent != null) result.correspondent = correspondent;
  ...
  factory AccountAccess.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AccountAccess.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountAccess', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'accountAccessId', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'usrId', $pb.PbFieldType.OU3)
    ..aOS(3, _omitFieldNames ? '' : 'correspondent')
    ..aOS(4, _omitFieldNames ? '' : 'rep')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AccountAccess clone() => AccountAccess()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AccountAccess copyWith(void Function(AccountAccess) updates) => super.copyWith((message) => updates(message as AccountAccess)) as AccountAccess;
  ...
  @$core.override
  AccountAccess createEmptyInstance() => create();
  static $pb.PbList<AccountAccess> createRepeated() => $pb.PbList<AccountAccess>();
  @$core.pragma('dart2js:noInline')
  static AccountAccess getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AccountAccess>(create);
  static AccountAccess? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get accountAccessId => $_getIZ(0);
  @$pb.TagNumber(1)
  set accountAccessId($core.int value) => $_setUnsignedInt32(0, value);
  @$pb.TagNumber(1)
  $core.bool hasAccountAccessId() => $_has(0);
  @$pb.TagNumber(1)
  void clearAccountAccessId() => $_clearField(1);
  ...
  @$pb.TagNumber(4)
  $core.String get rep => $_getSZ(3);
  @$pb.TagNumber(4)
  set rep($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasRep() => $_has(3);
  @$pb.TagNumber(4)
  void clearRep() => $_clearField(4);
...
class ListAccountAccessRequest extends $pb.GeneratedMessage {
  factory ListAccountAccessRequest({
    $core.int? usrId,
  }) {
    final result = create();
    if (usrId != null) result.usrId = usrId;
  ...
  ListAccountAccessRequest._();

  factory ListAccountAccessRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ListAccountAccessRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAccountAccessRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'usrId', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAccountAccessRequest clone() => ListAccountAccessRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAccountAccessRequest copyWith(void Function(ListAccountAccessRequest) updates) => super.copyWith((message) => updates(message as ListAccountAccessRequest)) as ListAccountAccessRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListAccountAccessRequest create() => ListAccountAccessRequest._();
  @$core.override
  ListAccountAccessRequest createEmptyInstance() => create();
  static $pb.PbList<ListAccountAccessRequest> createRepeated() => $pb.PbList<ListAccountAccessRequest>();
  @$core.pragma('dart2js:noInline')
  static ListAccountAccessRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListAccountAccessRequest>(create);
  static ListAccountAccessRequest? _defaultInstance;
...
class ListAccountAccessResponse extends $pb.GeneratedMessage {
  factory ListAccountAccessResponse({
    $core.Iterable<AccountAccess>? accountAccess,
  }) {
    final result = create();
    if (accountAccess != null) result.accountAccess.addAll(accountAccess);
    return result;
  }

  ListAccountAccessResponse._();

  factory ListAccountAccessResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ListAccountAccessResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAccountAccessResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'usrpb'), createEmptyInstance: create)
    ..pc<AccountAccess>(1, _omitFieldNames ? '' : 'accountAccess', $pb.PbFieldType.PM, subBuilder: AccountAccess.create)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAccountAccessResponse clone() => ListAccountAccessResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAccountAccessResponse copyWith(void Function(ListAccountAccessResponse) updates) => super.copyWith((message) => updates(message as ListAccountAccessResponse)) as ListAccountAccessResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListAccountAccessResponse create() => ListAccountAccessResponse._();
  @$core.override
  ListAccountAccessResponse createEmptyInstance() => create();
  static $pb.PbList<ListAccountAccessResponse> createRepeated() => $pb.PbList<ListAccountAccessResponse>();
  @$core.pragma('dart2js:noInline')
  static ListAccountAccessResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListAccountAccessResponse>(create);
  static ListAccountAccessResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<AccountAccess> get accountAccess => $_getList(0);
}
